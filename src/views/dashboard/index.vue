<template>
  <div class="dashboard-container">
    ...
    <!-- 离职弹出层 -->
    <el-dialog :visible="showDialog" title="离职申请" @close="noFn">
      <el-form ref="ruleForm" label-width="120px" :rules="rules" :model="ruleForm">
        ...
        <el-form-item label="离职原因" prop="reason">
          <el-input v-model="ruleForm.reason" type="textarea" style="width:70%" :rows="3" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
      <el-row slot="footer" type="flex" justify="center">
        <el-col :span="6">
          <el-button size="small" type="primary" @click="yesFn">提交</el-button>
          <el-button size="small" @click="noFn">重置</el-button>
        </el-col>
      </el-row>
    </el-dialog>
  </div>
